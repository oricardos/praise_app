...
export default function instrumental() {
  ...
  if (instrumentalPage) {
    ...
    //captura dos iframes
    const youtubeEmbedesAcousticGuitar = document.querySelector(
      ".youtube-embeded-acoustic_guitar"
    );
    const youtubeEmbedesElectricGuitar = document.querySelector(
      ".youtube-embeded-electric_guitar"
    );
    const youtubeEmbedesKeyboard = document.querySelector(
      ".youtube-embeded-keyboard"
    );
    const youtubeEmbedesBass = document.querySelector(".youtube-embeded-bass");
    const youtubeEmbedesDrums = document.querySelector(
      ".youtube-embeded-drums"
    );
